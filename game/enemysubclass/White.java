 ...
 * White
 * 
 * Enemy subclass representing a White bird enemy.
...
public class White extends Enemy {
    ...
    private void loadSpriteSheet() {
        try {
            ...
            System.out.println("Could not load White sprite sheet: " + e.getMessage());
            try {
                this.image = ImageIO.read(new File("images/bird_2_White.png"));
            } catch (IOException e2) {
                System.out.println("Could not load White image: " + e2.getMessage());
            }
        }
    }
